...
<body>
	...
	<header>
		<div id="logo">
			<a href="index"> <img src="resources/img/logo.png"
				alt="logo inovatec">
			</a> GESTOR INOVATEC - O.S - INCLUIR
		</div>
	</header>
	<section>

		<form action="incluir-os-bd" method="post">
			<br>
			<div id="pesquisar">
			...
			<br> <input type="hidden" id="id" name="id" required="required"
				value="${os[0].id}"> <label for="razaoSocial">Razão
				Social:</label> <input type="text" id="razaoSocial" name="razaoSocial"
				required="required" value="${os[0].razaoSocial}" readonly="readonly">
			<label for="nome-fantasia">Nome Fantasia:</label> <input type="text"
				id="nomeFantasia" name="nomeFantasia" required="required"
				value="${os[0].nomeFantasia}" readonly="readonly"> <label
				for="cnpj-cpf">CNPJ/CPF:</label> <input type="number" id="cnpj_cpf"
				name="cnpj_cpf" required="required" value="${os[0].cnpj_cpf}"
				readonly="readonly"> <label for="endereco">Endereço:</label>
			<input type="text" id="endereco" name="endereco" required="required"
				value="${os[0].endereco}" readonly="readonly"> <label
				for="cidade">Cidade:</label> <input type="text" id="cidade"
				name="cidade" required="required" value="${os[0].cidade}"
				readonly="readonly"> <label for="estado">Estado:</label> <input
				type="text" id="estado" name="estado" required="required"
				value="${os[0].estado}" readonly="readonly"> <label
				for="cep">CEP:</label> <input type="text" id="cep" name="cep"
				required="required" value="${os[0].cep}" readonly="readonly">
			<label for="telefone">Telefone:</label> <input type="text"
				id="telefone" name="telefone" required="required"
				value="${os[0].telefone}" readonly="readonly"> <label
				for="email">E-mail:</label> <input type="email" name="email"
				id="email" required="required" value="${os[0].email}"
				readonly="readonly"> <label for="contrato">Contrato:</label>
			<input type="text" name="contrato" id="contrato" required="required"
				value="${os[0].contrato}" readonly="readonly"> <label
				for="valor">Valor:</label> <input type="text" name="valor"
				id="valor" required="required" value="" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$"> <label for="valor">Valor
				Hora:</label> <input type="text" name="valor_hora" id="valor_hora"
				required="required" value=""> <label>SITUAÇÃO O.S:</label> <select
				name="situacao">
			...
			<textarea rows="10" cols="5" id="servico_executado"
				name="servico_executado"></textarea>
	...
	<script src="resources/js/incluir-os.js"></script>
</body>
